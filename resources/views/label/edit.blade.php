    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8  space-y-6">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg ">
            <div class="max-w-xl">
                ...
                {{ html()->label(__('views.label.edit.labels.name'), 'name')->class('block mb-2 text-lg font-medium text-gray-900 dark:text-white') }}
                ...
                {{ html()->label(__('views.label.edit.labels.description'), 'description')->class('block mb-2 text-lg font-medium text-gray-900 dark:text-white') }}
